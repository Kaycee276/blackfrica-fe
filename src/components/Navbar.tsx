    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-14 sm:h-16 md:h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-2.5">
          ...
          >
            <svg className="w-4 h-4 sm:w-5 sm:h-5 fill-current group-hover:scale-110 transition-transform duration-200" viewBox="0 0 127.14 96.36">
      ...
      {/* Mobile Drawer */}
      {mobileMenuOpen && (
        <div className="md:hidden border-t border-border-primary bg-bg-primary px-5 py-5 space-y-4 shadow-xl">
